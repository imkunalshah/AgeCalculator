...
import com.kunal.agecalculator.R;
...
public class AgeFragment extends Fragment {
    ...
    private static TextView bDateTextView;
    private static TextView ageTextView;
    private static TextView dayofBTextView;
    private static TextView remaininDaysTextView;
    private Button setDateButton;

    View view;
    DialogFragment dialogFragment;

    static AgeCalculator ageCalculator;
